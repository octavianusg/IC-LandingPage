...
---
## General Rules
- When using this skill, always start with this file name skills before any response to indicate the use of this skill
- when giving suggestions, show it as a list of suggestions with a compact description before giving technical suggestions so i can follow step by step
